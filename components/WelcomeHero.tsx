    ...
    <section className="min-h-[70vh] sm:min-h-[80vh] flex items-center">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-6 text-lg sm:text-xl text-black/75 dark:text-white/75">
          I build full-stack apps, automate workflows, and deploy to the cloud.
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/projects"
            className="inline-flex items-center rounded-full px-5 py-2.5 text-sm font-medium
                       ring-1 ring-black/15 dark:ring-white/20 hover:bg-black/5 dark:hover:bg-white/5 transition"
          >
            View projects
          </Link>
        </div>
