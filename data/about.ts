...
export const about: AboutContent = {
  ...
  intro: [
    ...
    "Recently I’ve built a phylogenetic analysis platform hosted on AWS, a restaurant reviews app with secure auth, and internal automations in Microsoft's Power Platform. I enjoy turning messy, manual workflows into reliable, automated systems.",
  ],
  strengths: [
